...
def index(req):
    ...
    for movie in movies:
        ...
        tablecontents += '<td><a href="http://pythonista.learning.edu/~heidee/details1?cd_id='+str(movie[0])+'" class="btn btn-info btn-sm active">Details</a></td>'
        tablecontents += "</tr>"
        i = i + 1
